class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("button", { onClick: () => {this.startNewGame();} }, "New Game"), 
      React.createElement("button", { onClick: () => {this.hit();} }, "Hit"), 
      React.createElement("button", { onClick: () => {this.stand();} }, "Stand")), 


      React.createElement("p", null, "Wallet: $", this.state.wallet),

      !this.state.currentBet ? 
      React.createElement("div", { className: "input-bet" }, 
      React.createElement("form", null, 
      React.createElement("input", { type: "text", name: "bet", placeholder: "", value: this.state.inputValue, onChange: this.inputChange.bind(this) })), 

      React.createElement("button", { onClick: () => {this.placeBet();} }, "Place Bet")) :
      ...
      this.state.gameOver ? 
      React.createElement("div", { className: "buttons" }, 
      React.createElement("button", { onClick: () => {this.startNewGame('continue');} }, "Continue")) :

      null, 

      React.createElement("p", null, "Your Hand (", this.state.player.count, ")"), 
      React.createElement("table", { className: "cards" }, 
      React.createElement("tr", null,
      this.state.player.cards.map((card, i) => {
        return React.createElement(Card, { key: i, number: card.number, suit: card.suit });
      }))), 



      React.createElement("p", null, "Dealer's Hand (", this.state.dealer.count, ")"), 
      React.createElement("table", { className: "cards" }, 
      React.createElement("tr", null,
